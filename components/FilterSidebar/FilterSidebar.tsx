    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 z-50 flex justify-end">
          <div id="sidebar" className="bg-white w-64 sm:w-96 p-4 shadow-md h-full">
            {/* Stängningsknapp */}
            <button
            ...
            <div className='flex flex-col sm:flex-row justify-between items-center gap-2 mt-5 w-full'>
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-1/2'>Rensa </button>
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded  w-1/2'>VIsa</button>
            </div>
          </div>
